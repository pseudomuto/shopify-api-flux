...
module.exports = {
  ...
  Session: (0, _keymirror2["default"])({
    SET_DOMAIN_AND_TOKEN: null
  })
};

},{"keymirror":33}],2:[function(require,module,exports){
"use strict";
...
},{"./actions/ProductActions":3,"./actions/SessionActions":5,"./actions/ShopActions":6,"./stores/ProductsStore":9,"./stores/ShopStore":11}],3:[function(require,module,exports){
"use strict";
...
var _ResourceActions2 = require("./ResourceActions");

var _ResourceActions3 = _interopRequireDefault(_ResourceActions2);

var ProductActions = (function (_ResourceActions) {
  _inherits(ProductActions, _ResourceActions);

  function ProductActions() {
    _classCallCheck(this, ProductActions);

    _get(Object.getPrototypeOf(ProductActions.prototype), "constructor", this).call(this, "product");
  }

  _createClass(ProductActions, [{
    key: "fetchByCollection",
    value: function fetchByCollection(collectionId) {
      return this.fetch({ collection_id: collectionId });
    }
  }, {
    key: "fetchAllSince",
    value: function fetchAllSince(id) {
      return this.fetch({ since_id: id });
    }
  }]);

  return ProductActions;
})(_ResourceActions3["default"]);

module.exports = new ProductActions();

},{"./ResourceActions":4}],4:[function(require,module,exports){
"use strict";
...
var _utilitiesWebAPI = require("../utilities/WebAPI");

var _utilitiesWebAPI2 = _interopRequireDefault(_utilitiesWebAPI);

var _dispatcherApiDispatcher = require("../dispatcher/ApiDispatcher");

var _dispatcherApiDispatcher2 = _interopRequireDefault(_dispatcherApiDispatcher);
...
var _default = (function () {
  ...
  _createClass(_default, [{
    ...
    value: function fetch(query) {
      ...
      var url = this.urlFor(query);
      var dispatch = this._dispatchMerge.bind(this);
      var request = _utilitiesWebAPI2["default"].get(url);

      if (this._isSingleResourceQuery(query)) {
        var _ret = (function () {
          var resource = _this.resource;
          return {
            v: request.then(function (response) {
              return dispatch([response[resource]]);
            })
          };
        })();
      ...
      var resource = this.resourceCollection;
    ...
    key: "mergeAction",
    value: function mergeAction() {
      return _Constants2["default"].Actions["MERGE_" + this.resourceCollection.toUpperCase()];
    }
  }, {
    key: "clearAction",
    value: function clearAction() {
      return _Constants2["default"].Actions["CLEAR_" + this.resourceCollection.toUpperCase()];
    }
  }, {
    key: "urlFor",
    value: function urlFor(query) {
      if (this._isSingleResourceQuery(query)) {
        var template = _lodash2["default"].template("/admin/" + this.resourceCollection + "/<%= id %>.json");
        return template({ id: query });
      }

      var params = this._parameterize(query);
      var url = "/admin/" + this.resourceCollection + ".json";

      return params ? url + "?" + params : url;
    }
  }, {
    key: "_parameterize",
    value: function _parameterize(obj) {
      if (!obj) {
        return "";
      }
    ...
    key: "_isSingleResourceQuery",
    value: function _isSingleResourceQuery(query) {
      return _lodash2["default"].includes(["string", "number"], typeof query);
    }
  }, {
    key: "_dispatchMerge",
    value: function _dispatchMerge(items) {
      var action = {
        actionType: this.mergeAction(),
        items: items
      };

      _dispatcherApiDispatcher2["default"].dispatch(action);
    }
  }]);
...
},{"../Constants":1,"../dispatcher/ApiDispatcher":7,"../utilities/WebAPI":12,"lodash":34}],5:[function(require,module,exports){
"use strict";
...
var InvalidShopNameException = function InvalidShopNameException(message) {
  _classCallCheck(this, InvalidShopNameException);

  this.name = "InvalidShopNameException";
  this.message = message;
};

var InvalidTokenException = function InvalidTokenException(message) {
  _classCallCheck(this, InvalidTokenException);
...
var SessionActions = (function () {
  ...
  _createClass(SessionActions, [{
    key: "init",
    value: function init(domain, token) {
      verifyDomain(domain);
      verifyToken(token);

      _dispatcherApiDispatcher2["default"].dispatch({
        actionType: _Constants2["default"].Session.SET_DOMAIN_AND_TOKEN,
...
},{"../Constants":1,"../dispatcher/ApiDispatcher":7}],6:[function(require,module,exports){
"use strict";
...
var SHOP_URL = "/admin/shop.json";

function notifyDispatcher(response) {
  _dispatcherApiDispatcher2["default"].dispatch({
    actionType: _Constants2["default"].Actions.SET_SHOP,
    shop: response.shop
  });
}
...
var ShopActions = (function () {
  function ShopActions() {
    _classCallCheck(this, ShopActions);
  }

  _createClass(ShopActions, [{
    key: "fetch",
    value: function fetch() {
      return _utilitiesWebAPI2["default"].get(SHOP_URL).then(function (response) {
        return notifyDispatcher(response);
      });
    }
  }]);
...
},{"../Constants":1,"../dispatcher/ApiDispatcher":7,"../utilities/WebAPI":12}],7:[function(require,module,exports){
"use strict";
...
var _fluxUtils2 = _interopRequireDefault(_fluxUtils);
...
function mergeItems(state, items) {
  var initialState = state.set(items[0].id, items[0]);
...
var BaseStore = (function (_Flux$MapStore) {
  _inherits(BaseStore, _Flux$MapStore);
  ...
  _createClass(BaseStore, [{
    ...
    value: function where(source) {
      return _lodash2["default"].where(this.getState().toArray(), source);
    }
  }, {
    key: "mergeAction",
    value: function mergeAction() {
      return _Constants2["default"].Actions["MERGE_" + this._actionResourceName()];
    }
  }, {
    key: "clearAction",
    value: function clearAction() {
      return _Constants2["default"].Actions["CLEAR_" + this._actionResourceName()];
    }
  }, {
    key: "reduce",
    ...
    key: "areEqual",
    value: function areEqual(state1, state2) {
      return _lodash2["default"].isEqual(state1, state2);
    }
  }, {
    key: "_actionResourceName",
    value: function _actionResourceName() {
      return this.constructor.name.replace(/Store$/, "").toUpperCase();
    }
  }]);

  return BaseStore;
})(_fluxUtils2["default"].MapStore);

module.exports = BaseStore;

},{"../Constants":1,"flux/utils":32,"lodash":34}],9:[function(require,module,exports){
"use strict";
...
var ProductsStore = (function (_BaseStore) {
  _inherits(ProductsStore, _BaseStore);

  function ProductsStore() {
    _classCallCheck(this, ProductsStore);

    _get(Object.getPrototypeOf(ProductsStore.prototype), "constructor", this).apply(this, arguments);
  }

  return ProductsStore;
})(_BaseStore3["default"]);

module.exports = new ProductsStore(_dispatcherApiDispatcher2["default"]);

},{"../Constants":1,"../dispatcher/ApiDispatcher":7,"./BaseStore":8}],10:[function(require,module,exports){
"use strict";
...
var Store = _fluxUtils2["default"].Store;
...
var SessionStore = (function (_Store) {
  ...
  function SessionStore() {
    ...
    _get(Object.getPrototypeOf(SessionStore.prototype), "constructor", this).apply(this, arguments);
  }
  ...
  _createClass(SessionStore, [{
    ...
    value: function __onDispatch(action) {
      switch (action.actionType) {
        case _Constants2["default"].Session.SET_DOMAIN_AND_TOKEN:
...
module.exports = new SessionStore(_dispatcherApiDispatcher2["default"]);

},{"../Constants":1,"../dispatcher/ApiDispatcher":7,"flux/utils":32}],11:[function(require,module,exports){
"use strict";
...
var ShopStore = (function (_Store) {
  _inherits(ShopStore, _Store);

  function ShopStore() {
    _classCallCheck(this, ShopStore);

    _get(Object.getPrototypeOf(ShopStore.prototype), "constructor", this).apply(this, arguments);
  }
  ...
  _createClass(ShopStore, [{
    ...
    value: function __onDispatch(action) {
      switch (action.actionType) {
        case _Constants2["default"].Actions.SET_SHOP:
          shop = action.shop;
          this.__emitChange();
          break;
        case _Constants2["default"].Actions.CLEAR_SHOP:
          shop = null;
          this.__emitChange();
          break;
        default:
...
module.exports = new ShopStore(_dispatcherApiDispatcher2["default"]);

},{"../Constants":1,"../dispatcher/ApiDispatcher":7,"flux/utils":32}],12:[function(require,module,exports){
"use strict";
...
function _performRequest(method, url, options) {
  ...
  options.headers[_Constants2["default"].OAUTH_HEADER] = _storesSessionStore2["default"].getAccessToken();

  return fetch("https://" + _storesSessionStore2["default"].getDomain() + url, options).then(function (response) {
...
},{"../Constants":1,"../stores/SessionStore":10,"whatwg-fetch":35}],13:[function(require,module,exports){
...
},{"_process":13,"fbjs/lib/invariant":29}],16:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./FluxStoreGroup":21,"_process":13,"fbjs/lib/invariant":29,"fbjs/lib/shallowEqual":30}],17:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./FluxReduceStore":19,"_process":13,"fbjs/lib/invariant":29,"immutable":31}],18:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./FluxStoreGroup":21,"_process":13,"fbjs/lib/invariant":29}],19:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./FluxStore":20,"./abstractMethod":22,"_process":13,"fbjs/lib/invariant":29}],20:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":13,"fbemitter":23,"fbjs/lib/invariant":29}],21:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":13,"fbjs/lib/invariant":29}],22:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":13,"fbjs/lib/invariant":29}],23:[function(require,module,exports){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./lib/BaseEventEmitter":24}],24:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EmitterSubscription":25,"./EventSubscriptionVendor":27,"_process":13,"fbjs/lib/emptyFunction":28,"fbjs/lib/invariant":29}],25:[function(require,module,exports){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventSubscription":26}],26:[function(require,module,exports){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":13,"fbjs/lib/invariant":29}],28:[function(require,module,exports){
/**
...
},{"./lib/FluxContainer":16,"./lib/FluxMapStore":17,"./lib/FluxMixinLegacy":18,"./lib/FluxReduceStore":19,"./lib/FluxStore":20}],33:[function(require,module,exports){
/**
