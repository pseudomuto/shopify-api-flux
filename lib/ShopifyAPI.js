...
export default {
  ...
  Location:  new APIProxy(require("./resources/Location"), require("./stores/LocationsStore")),
  ...
  Policy:    new APIProxy(require("./resources/Policy"), require("./stores/PoliciesStore")),
