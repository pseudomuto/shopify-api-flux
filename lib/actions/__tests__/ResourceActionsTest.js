...
describe("ResourceActions", () => {
  ...
  describe("mergeAction", () => {
    it("concatenates the collection name with MERGE", () => {
      expect(actions.mergeAction()).toBe(Constants.Data.MERGE_THINGS);
    });
  });

  describe("clearAction", () => {
    it("concatenates the collection name with CLEAR", () => {
      expect(actions.clearAction()).toBe(Constants.Data.CLEAR_THINGS);
    });
  });
  ...
  describe("fetch", () => {
    var request;
    let actionType = Constants.Data.MERGE_THINGS;
