...
class Order extends Base {
   ...
   */
  close(id) {
    return this._simplePost(id, "close");
  }
   ...
   */
  open(id) {
    return this._simplePost(id, "open");
  }
   ...
   */
  cancel(id, options = {}) {
    return this._simplePost(id, "cancel", options);
  }

  _simplePost(id, action, resource) {
    let url      = this._subURL(action, id);
