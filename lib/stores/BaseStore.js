  ...
  reduce(state, action) {
    switch(action.actionType) {
      ...
      case this._actions.clearAction:
        return state.clear();
      case this._actions.countAction:
        this._counts.set(action.query, action.count);
        this.__emitChange(); // force change event
        return state;
      default:
        return state;
    }
